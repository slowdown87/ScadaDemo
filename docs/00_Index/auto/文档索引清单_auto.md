# 文档索引清单
> 文档版本: vv4.1> 创建日期: 2026-04-30> 更新日期: 2026-05-12> 项目名称: 茶饮料生产线文档体系> **自动生成**: 本文档由 index_generator.py 自动生成
---
## 📁 文档目录结构
...
| 文档 | 版本 | 更新日期 | 说明 |
| ---- | ---- | -------- | ---- |
| 茶饮料_CIP配方表_auto.md | v1.0 | 2026-05-11 |  |
| 茶饮料_产品配方表_auto.md | v1.0 | 2026-05-11 |  |
