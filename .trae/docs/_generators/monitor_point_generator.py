...
OUTPUT_FILE = SCRIPT_DIR.parent / "03_Device" / "auto" / "茶饮料_监控点表_auto.md"
...
def load_all_devices():
    ...
    if CONFIG_FILE.exists():
        ...
        for section, device_list in devices_section.items():
...
def generate_document():
    ...
    lines.append("| 项目 | 内容 |")
    lines.append("| ---- | ---- |")
    lines.append("| **数据来源** | `03_Device/configs/devices_*.yaml` |")
    lines.append("| **生成器脚本** | `03_Device/_generators/monitor_point_generator.py` |")
    lines.append("| **重新生成命令** | `python 03_Device/_generators/monitor_point_generator.py` |")
    lines.append("")
    lines.append("### 修改流程")
    lines.append("")
    lines.append("1. 编辑 `03_Device/configs/devices_*.yaml`")
    lines.append("2. 运行 `python 03_Device/_generators/monitor_point_generator.py`")
    lines.append("3. 检查生成的 `03_Device/auto/茶饮料生产线监控点表_auto.md`")
    lines.append("")
    lines.append("---")
    lines.append("")
