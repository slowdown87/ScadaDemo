...
│    │                                      │                  │                                         │    │
│    │     ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐         │    │
│    │     │ WT水处理  │  │ WT    │  │ 192.168.2.11 │         │    │
│    │     │ TH茶叶前处理 │  │ TH    │  │ 192.168.2.12 │         │    │
│    │     │ EX萃取   │  │ EX    │  │ 192.168.2.13 │         │    │
│    │     │ FL过滤   │  │ FL    │  │ 192.168.2.14 │         │    │
│    │     │ BL调配   │  │ BL    │  │ 192.168.2.15 │         │    │
│    │     │ HM均质   │  │ HM    │  │ 192.168.2.16 │         │    │
│    │     │ UH     │  │ UH    │  │ 192.168.2.17 │         │    │
│    │           │            │            │            │            │            │                  │    │
│    │     ┌─────┴────────────┴────────────┴────────────┴────────────┴────────────┘                  │    │
│    │     │                         H-Sync光纤环网                                                │    │
...
│    │           │            │            │            │            │                                │    │
│    │     ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐         │    │
│    │     │ BF制瓶   │  │ BF    │  │ 192.168.2.18 │         │    │
│    │     │ PF灌装   │  │ PF    │  │ 192.168.2.19 │         │    │
│    │     │ CG旋盖   │  │ CG    │  │ 192.168.2.20 │         │    │
│    │     │ LI灯检   │  │ LI    │  │ 192.168.2.21 │         │    │
│    │     │ CI喷码   │  │ CI    │  │ 192.168.2.22 │         │    │
│    │           │            │            │            │            │            │                  │    │
│    │           └────────────┴────────────┴────────────┴────────────┴────────────┘                  │    │
│    │                                    H-Sync光纤环网                                                │    │
│    │                          ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐                    │    │
│    │                          │ LB贴标   │  │ LB    │  │ 192.168.2.23 │                    │    │
│    │                          │ CA装箱   │  │ CA    │  │ 192.168.2.24 │                    │    │
│    │                          │ PK膜包码垛 │  │ PK    │  │ 192.168.2.25 │                    │    │
│    │                          │ CP     │  │ CP    │  │ 192.168.2.26 │                    │    │
│    └───────────────────────────────────────────────────────────────────────────────────────────────┘    │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
| ------ | --------- | ------------- | ---- | ---------- | ------ | --------- |
| WT水处理 | Water Treatment | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~200点 | 公用工程 |
| TH茶叶前处理 | Tea Handling | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~100点 | 防爆区域 |
| EX萃取 | Extraction | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~180点 | 批次控制 |
| FL过滤 | Filtration | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~120点 | 连续流程 |
| BL调配 | Blending | CPU 1517-2 PN | 2×PN | H-Sync光纤环网 | ~200点 | 核心批次 |
| HM均质 | Homogenization | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~80点 | 均质处理 |
| UH UHT杀菌 | UHT Processing | CPU 1517-2 PN | 2×PN | H-Sync光纤环网 | ~220点 | **CCP关键** |
| BF制瓶 | Bottle Forming | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~150点 | 高速同步 |
| PF灌装 | Packaging Fill | CPU 1517-2 PN | 2×PN | H-Sync光纤环网 | ~180点 | **超高速** |
| CG旋盖 | Capping | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~80点 | 跟随灌装 |
| LI灯检 | Light Inspection | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~60点 | 检测设备 |
| CI喷码 | Coding | CPU 1215C | 1×PN | 无 | ~40点 | 产品追溯 |
| LB贴标 | Labeling | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~60点 | 中等速度 |
| CA装箱 | Cartoning | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~80点 | 批量控制 |
| PK膜包码垛 | Packing | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~120点 | 末端设备 |
| CP CIP清洗 | Cleaning In Place | CPU 1515-2 PN | 2×PN | H-Sync光纤环网 | ~140点 | 独立系统 |
...
| PLC编号 | 控制工段 | IP地址 | 备注 |
|---------|----------|--------|------|
| WT水处理 | Water Treatment | 192.168.2.11 | 公用工程 |
| TH茶叶前处理 | Tea Handling | 192.168.2.12 | 防爆区域 |
| EX萃取 | Extraction | 192.168.2.13 | 批次控制 |
| FL过滤 | Filtration | 192.168.2.14 | 连续流程 |
| BL调配 | Blending | 192.168.2.15 | 核心批次 |
| HM均质 | Homogenization | 192.168.2.16 | 均质处理 |
| UH UHT杀菌 | UHT Processing | 192.168.2.17 | CCP关键 |
| BF制瓶 | Bottle Forming | 192.168.2.18 | 高速同步 |
| PF灌装 | Packaging Fill | 192.168.2.19 | 超高速 |
| CG旋盖 | Capping | 192.168.2.20 | 跟随灌装 |
| LI灯检 | Light Inspection | 192.168.2.21 | 检测设备 |
| CI喷码 | Coding | 192.168.2.22 | 产品追溯 |
| LB贴标 | Labeling | 192.168.2.23 | 中等速度 |
| CA装箱 | Cartoning | 192.168.2.24 | 批量控制 |
| PK膜包码垛 | Packing | 192.168.2.25 | 末端设备 |
| CP CIP清洗 | Cleaning In Place | 192.168.2.26 | 独立系统 |
...
│           └── Functions
| ______________________________
│   └── PLC_CP CIP清洗_CP_CleaningInPlace
