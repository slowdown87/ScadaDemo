...
| Phase 3 里程碑 | 物料批次全流程追踪 + 3D动画流畅 | ✅ completed |
...
| 任务 | 描述 | 验收标准 | 优先级 | 状态 |
|------|------|---------|--------|------|
| T3.1 | 批次数据结构设计 | 批次号+物料+位置+状态 | HIGH | ✅ completed |
| T3.2 | 状态机定义 | in_transit/stored/in_process等 | HIGH | ✅ completed |
| T3.3 | 位置更新服务 | 实时位置追踪 | HIGH | ✅ completed |
| T3.4 | 历史轨迹展示 | 轨迹线/热力图 | MED | ✅ completed |
| T3.5 | 物料3D动画 | 移动+旋转+缩放 | MED | ✅ completed |
| T3.6 | 工艺步骤配置 | SOP定义 | MED | ✅ completed |
